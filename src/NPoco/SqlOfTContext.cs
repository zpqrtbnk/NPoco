...
namespace NPoco
{
    public class Sql<TContext> : Sql
    {
        ...
        public new SqlJoinClause<TContext> LeftOuterJoin(string table) { return Join("OUTER LEFT JOIN ", table); }
        ...
        //public new Sql<T> For<T>(T context)
        //{
        //    throw new InvalidOperationException("Already an Sql<TContext>.");
        //}
    }
}
