...
namespace NPoco
{
    public class Sql
    {
        ...
        public SqlJoinClause LeftOuterJoin(string table) { return Join("OUTER LEFT JOIN ", table); }
        ...
        //public Sql<TContext> For<TContext>(TContext context)
        //{
        //    if (_sql != null || _args != null || _rhs != null)
        //        throw new InvalidOperationException("Cannot use For on a non-empty Sql.");
